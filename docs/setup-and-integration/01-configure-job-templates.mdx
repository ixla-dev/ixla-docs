...
- **Layouts** - Association between *SFJ Files* and the *Card Side* on which they should be printed
...
Porvide a name and a description for the your template and click the <span className="btn">CREATE TEMPLATE</span> button
