...
We will populate data exchange tables with personalization data that will be used to update entities values before engraving. Data exchange tables also contain columns, managed by IWS, that are used to persist workflows execution status and results.
