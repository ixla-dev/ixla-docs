...
<!-- links  -->
[box]:./system-overview/box
[iws]:./system-overivew/iws
[webapp]:./system-overview/iws-webapp
[samlight]:./scaps-samlight
<!-- end links  -->
...
how to ***provide personalization data*** to the system and ***schedule jobs*** via ***database integration***
